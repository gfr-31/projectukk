    ...
    <body class="bg-purple">
        ...
        <div class="stars">
            ...
            <div class="central-body">
                <img class="image-404" src="{{ asset('gambar/svg/font.png') }}" width="500px" loading="lazy">
                <a onclick="goBack()" class="btn-go-home" target="_blank">GO BACK</a>
            </div>
            <div class="objects">
                <img class="object_rocket" src="http://salehriaz.com/404Page/img/rocket.svg" width="100px" loading="lazy">
