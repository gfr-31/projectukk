...
@section('kelas')
    ...
    <script>
        ...
        function addInput() {
            ...
            newInput.innerHTML =
                '<div class="form-group"><label for="inputNew" >Kelas</label><input type="text" class="form-control" name="kelas[]" placeholder="X(A)" required></div><button type="button" class="btn btn-danger btn-sm mb-3" onclick="removeInput(this)">Hapus</button>';
