                                                    ...
                                                    <div class=" row mt-2">
                                                        ...
                                                        <div class=" col-7">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="totalTagihan" id="totalTagihan"
                                                                value="{{ old('totalTagihan') }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="juli" id="tagihan1" value="{{ old('juli') }}" oninput="formatRupiahs('tagihan1')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="agustus" id="tagihan2" value="{{ old('agustus') }}" oninput="formatRupiahs('tagihan2')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="september" id="tagihan3" value="{{ old('september') }}" oninput="formatRupiahs('tagihan3')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="oktober" id="tagihan4" value="{{ old('oktober') }}"  oninput="formatRupiahs('tagihan4')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="november" id="tagihan5" value="{{ old('november') }}"  oninput="formatRupiahs('tagihan5')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="desember" id="tagihan6" value="{{ old('desember') }}"  oninput="formatRupiahs('tagihan6')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="january" id="tagihan7" value="{{ old('january') }}"  oninput="formatRupiahs('tagihan7')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="februari" id="tagihan8" value="{{ old('februari') }}"  oninput="formatRupiahs('tagihan8')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="maret" id="tagihan9" value="{{ old('maret') }}"  oninput="formatRupiahs('tagihan9')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="april" id="tagihan10" value="{{ old('april') }}"  oninput="formatRupiahs('tagihan10')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="mei" id="tagihan11" value="{{ old('mei') }}"  oninput="formatRupiahs('tagihan11')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class=" form-group">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-9">
                                                    ...
                                                    @enderror
                                                    <input class="form-control form-control-sm" type="text"
                                                        name="juni" id="tagihan12" value="{{ old('juni') }}"  oninput="formatRupiahs('tagihan12')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
