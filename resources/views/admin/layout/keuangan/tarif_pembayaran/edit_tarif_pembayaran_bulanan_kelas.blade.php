                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-8">
                                                    <input class="form-control" id=""
                                                        value="{{ $t->TahunAjaran->tahun_ajaran }}" type="text" readonly>
                                                    <input class="form-control" name="tj" id=""
                                                        value="{{ $t->TahunAjaran->id }}" type="hidden">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="juli"
                                            id="tagihan1"
                                            value="{{ 'Rp. ' . number_format((float) $t->juli, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="agustus"
                                            id="tagihan2"
                                            value="{{ 'Rp. ' . number_format((float) $t->agustus, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="september"
                                            id="tagihan3"
                                            value="{{ 'Rp. ' . number_format((float) $t->september, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="oktober"
                                            id="tagihan4"
                                            value="{{ 'Rp. ' . number_format((float) $t->oktober, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="november"
                                            id="tagihan5"
                                            value="{{ 'Rp. ' . number_format((float) $t->november, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="desember"
                                            id="tagihan6"
                                            value="{{ 'Rp. ' . number_format((float) $t->desember, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="january"
                                            id="tagihan7"
                                            value="{{ 'Rp. ' . number_format((float) $t->january, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="februari"
                                            id="tagihan8"
                                            value="{{ 'Rp. ' . number_format((float) $t->february, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="maret"
                                            id="tagihan9"
                                            value="{{ 'Rp. ' . number_format((float) $t->maret, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="april"
                                            id="tagihan10"
                                            value="{{ 'Rp. ' . number_format((float) $t->april, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="mei"
                                            id="tagihan11"
                                            value="{{ 'Rp. ' . number_format((float) $t->mei, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class=" col-9">
                                        <input class="form-control form-control-sm" type="text" name="juni"
                                            id="tagihan12"
                                            value="{{ 'Rp. ' . number_format((float) $t->juni, 0, ',', '.') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class=" form-group">
                                <div class="align-items-center">
                                    <div class="row">
                                        ...
                                        <div class=" col-6 ">
                                            <a href="/admin/tarif-pembayaran/{{ $t->tahun_ajaran_id }}/{{ $t->tipe }}"
